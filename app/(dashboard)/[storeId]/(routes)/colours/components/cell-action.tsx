...
export const CellAction = function({ data } : CellActionProps)
{
    ...
    {
        setIsLoading(true);
        const promise = axios.delete(`/api/${params.storeId}/colours/${data.id}`);

        toast.promise(promise, {
            'loading': 'Deleting colour...',
            'success': (res) => {
                router.refresh();
                return `Deleted the colour '${data.name}'!`
            },
        ...
        <>
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem onClick={() => router.push(`/${params.storeId}/colours/${data.id}`)} disabled={isLoading} className="cursor-pointer">
